...
function EditEvent() {
  ...
  useEffect(() => {
    (async () => {
      const response = await GetById(getEventById, id);
      debugger;
      ...
      resetObj.Date = response.data.data.date;
      resetObj.Time = response.data.data.time;
      resetObj.Description = response.data.data.description;
      resetObj.OrganizerName = response.data.data.organizerName;
      resetObj.OrganizerNumber = response.data.data.organizerNumber;
      reset(resetObj);
    })();
  ...
  return (
    <div>
      ...
      <DashboardHeading text={"Edit Event"} isBack={true} link="/events" />
