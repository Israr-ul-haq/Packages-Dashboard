...
function EditFeed() {
  ...
  useEffect(() => {
    (async () => {
      ...
      setResult(response.data.data.filePath);
      const resetObj = {
        Description: "",
        Title: "",
      };
  ...
  const submitForm = async (formData) => {
    ...
    const body = {
      ...
      Description: "",
      FilePath: "",
      UserId: JSON.parse(localStorage.getItem("packagesuser")).user.id,
    };
    ...
    if (uploadImage !== null) {
      ...
      body.FilePath = imageResponse1.data.data.filePath;
    }
    debugger;
  ...
  return (
    <div>
      ...
      <DashboardHeading text={"Edit Feed"} isBack={true} link="/feeds" />
